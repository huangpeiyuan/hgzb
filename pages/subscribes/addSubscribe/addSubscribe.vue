			...
			addSubscribe() {
				...
				if (!UserInfo) {
					...
					if (this.canbesent === true) {
						...
						uni.request({
							url: 'https://haogz8.com:2443/recruit_brother/subscribe/addSubscribe',
							method: 'POST',
							data: {
			...
			changeSubscribe() {
				...
				if (this.UserInfo === '') {
					...
					if (this.canbesent === true) {
						...
						uni.request({
							url: 'https://haogz8.com:2443/recruit_brother/subscribe/changeSubscribe',
							method: 'POST',
							data: {
								intoAreaCodes: this.cityCode,
								subscribeType: this.biddingType,
