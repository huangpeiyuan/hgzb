	...
	export default {
		...
		onShow() {
			...
			if (UserInfo) {
				if (!UserInfo.subscribe) {
					...
					uni.request({
						url: "https://haogz8.com:2443/recruit_brother/subscribe/findSubscribeByOpenid",
						data: {
						...
						success(res) {
							...
							if (res.data.code === 0) {
								...
								if (res.data.data.subscribe) {
									...
									uni.request({
										url: "https://haogz8.com:2443//recruit_brother/recruit/findThirtyData",
										method: "GET",
										data: {
		...
		methods: {
			...
			async loadget() {
				...
				// const res = await this.$myRequest({
				// 	url: '//recruit_brother/recruit/findTenData?provinceCode=' + this.cityValue + '&announcementType=' + this.zType +
				...
				const res = await this.$myRequest({
					url: '//recruit_brother/recruit/findTenData?provinceCode=' + cityValue + '&announcementType=' + zType + '&day=' +
