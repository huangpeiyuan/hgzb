						...
						success(res) {
							...
							if (res.data.code === 0) {
								...
								if (res.data.data.subscribe) {
									...
									uni.request({
										url: "https://haogz8.com:2443/recruit_brother/historyCollection/findHistory?user_id",
										method: "GET",
										data: {
		...
		methods: {
			...
			async loadget() {
				...
				const res = await this.$myRequest({
					url: 'https://haogz8.com:2443/recruit_brother/historyCollection/findHistory'
				});
